  ...
  return (
    ...
    <Main>
      ...
      <Body style={window.innerWidth < 500?{flexDirection: 'column', justifyContent: 'center', width: '100%'}:{flexDirection: 'row'}}>
        <InputContainer>
              메인 : <input type="text" id="mainTitle" value={mainTitle} onChange={handleInputChange} placeholder={localStorage.getItem('mainTitle')}/>
        </InputContainer>
        <InputContainer>
              서브 : <input type="text" id="subTitle" value={subTitle} onChange={handleInputChange} placeholder={localStorage.getItem('subTitle')}/>
        </InputContainer>
